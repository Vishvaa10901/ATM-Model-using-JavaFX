...
public class ChangePin extends javax.swing.JFrame {
    ...
    public ChangePin(int card, int pin){
        initComponents();
        this.card = card;
        this.pin = pin;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int existing = Integer.parseInt(jTextField1.getText());
        int newpin = Integer.parseInt(jTextField2.getText());
        ...
        if(existing == this.pin){
            ...
            JFrame f=new JFrame();
            JOptionPane.showMessageDialog(f,"Invalid Pin");
        }
        // TODO add your handling code here:
